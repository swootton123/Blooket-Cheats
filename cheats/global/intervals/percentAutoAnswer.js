...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/swootton123/Blooket-Cheats/main/autoupdate/timestamps/global/intervals/percentAutoAnswer.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1707871478946 || iframe.contentWindow.confirm(error)) cheat();
    }
