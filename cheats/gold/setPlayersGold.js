...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/swootton123/Blooket-Cheats/main/autoupdate/timestamps/gold/setPlayersGold.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1707871479107 || iframe.contentWindow.confirm(error)) cheat();
    }
